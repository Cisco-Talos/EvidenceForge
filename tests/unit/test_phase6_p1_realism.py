...
@pytest.fixture
def dc_system():
    return System(hostname="DC-01", ip="10.10.100.10", os="Windows Server 2019", type="domain_controller")
...
class TestLocalResp:
    ...
    def test_internal_destination_sets_local_resp_true(self, activity_gen, state_manager, mock_emitters):
...
class TestLogonTypeDistribution:
    ...
    def test_workstation_no_type5_for_regular_users(self, activity_gen, state_manager, mock_emitters):
        ...
        for _ in range(200):
            ...
            activity_gen.execute_baseline_activity(user=user, system=system, time=ts, activity_type='logon')
            if mock_emitters['windows_event_security'].emit_event.called:
                last_call = mock_emitters['windows_event_security'].emit_event.call_args_list[-1][0][0]
    ...
    def test_server_type3_dominates(self, activity_gen, state_manager, mock_emitters):
        ...
        system = System(hostname="SRV-01", ip="10.10.100.50", os="Windows Server 2019", type="server")
        ts = datetime(2024, 3, 15, 10, 0, 0, tzinfo=timezone.utc)
    ...
    def test_detects_multiple_dcs(self):
        ...
        scenario = Scenario(
            ...
            environment=Environment(
                ...
                systems=[
                    System(hostname="DC-01", ip="10.10.100.10", os="Windows Server 2019", type="domain_controller"),
                    System(hostname="DC-02", ip="10.10.100.11", os="Windows Server 2019", type="domain_controller"),
    ...
    def test_detects_exchange(self):
        ...
        scenario = Scenario(
            ...
            environment=Environment(
                ...
                users=[User(username="j", full_name="J", email="j@x.com")],
                systems=[
                    System(hostname="SRV-EXCH-01", ip="10.10.100.16", os="Windows Server 2019", type="server"),
                    System(hostname="WKS-01", ip="10.10.10.1", os="Windows 10", type="workstation"),
                ],
            ),
            time_window=TimeWindow(start=datetime(2024, 1, 1, tzinfo=timezone.utc), duration="8h"),
