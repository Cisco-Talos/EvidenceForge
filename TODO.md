...
- [ ] **IN PROGRESS** Post-coherence blind review — generate a fresh dataset from the current branch and run a blind 50/50 real-vs-synthetic review focused on Zeek, proxy, TLS/x509/OCSP, DNS, DHCP, SMB files, and NTP realism after the proxy UA, intermediate CA, SMB filename, and NTP association fixes.
