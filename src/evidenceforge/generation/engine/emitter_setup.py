...
_ZEEK_FORMAT_NAMES = {
    ...
    'zeek_dhcp', 'zeek_ntp', 'zeek_weird', 'zeek_x509', 'zeek_ocsp',
    'zeek_pe', 'zeek_packet_filter', 'zeek_reporter',
}
...
_HOST_FORMATS = {
    'windows_event_security', 'windows_event_sysmon', 'ecar',
    'syslog', 'bash_history', 'web_access', 'proxy_access',
}
